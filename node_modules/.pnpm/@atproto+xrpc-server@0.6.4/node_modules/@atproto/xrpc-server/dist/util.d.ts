...
export declare function parseContentEncoding(contentEncoding?: string | string[]): string[];
export declare function createDecoder(encoding: string): Duplex;
...
export declare const parseReqNsid: (req: express.Request | IncomingMessage) => string;
